...
$(document).ready(function () {
	$("#firstlogininfo").dialog();
    $("#firsttimeinfo").dialog({
		modal: true
	});
...
{  
    ...
    function success_display(id,display_text)
    {
    	...
    	$("#"+id).css("display","none").html("<img src='assets/ok.jpg' width='15px' height='15px'/>"+display_text).fadeIn(500);
    }
    ...
    $("#register_name").autocomplete({
		...
		select: function(e, ui) {
            ...
            success_display("register_name_check","Correct Name")
			return false;
	...
	{
		$.post("getdata.php",{action:"username_check",username:this.value},function (data)
		{
			...
			if (json.yes) //if reply is yes the username is already used 
			{
				...
				success_hide("register_username_check");
			}
			else //else not used and can be used
			{
				success_display("register_username_check","Valid Username");
			}
		});
	});
	...
	$("#register_confirmpassword").blur(function ()
	{
		...
		{
			success_display("register_confirmpassword_check","Password Matched");
		}
		else
		{
			...
			//hide any previous success message
			success_hide("register_confirmpassword_check");
		}
	});
	...
	$("#register_email").blur(function () {
            ...
            {
            	success_hide("register_email_check");
            ...
            else
            {
                ...
                success_display("register_email_check","Valid Email Id");
            }
	});
