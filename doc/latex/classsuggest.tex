...
30         \textcolor{keywordflow}{if} ($row[\textcolor{stringliteral}{'typesuggest'}] == \textcolor{stringliteral}{"remove"}) \{
31             $this->suggested\_value = $row[\textcolor{stringliteral}{'suggested\_value'}];
32         \} \textcolor{keywordflow}{else} \{
33             $this->suggested\_value = json\_decode($row[\textcolor{stringliteral}{'suggested\_value'}], \textcolor{keyword}{true});
34         \}
35     \}
\end{DoxyCode}
...
177 
178 
179         \textcolor{comment}{//We have the member to be edited. Now apply the given operation}
180         \textcolor{keywordflow}{switch} ($this->typesuggest) \{
181             \textcolor{keywordflow}{case} \textcolor{stringliteral}{"child"}:
182                 $member->add\_son($this->suggested\_value[\textcolor{stringliteral}{'name'}], $this->suggested\_value[\textcolor{stringliteral}{'gender'}]);
183                 \textcolor{keywordflow}{break};
184             \textcolor{keywordflow}{case} \textcolor{stringliteral}{"remove"}:
185                 $member->remove();
186                 \textcolor{keywordflow}{break};
187             \textcolor{keywordflow}{case} \textcolor{stringliteral}{"edit"}:
188                 $member->edit($this->suggested\_value[\textcolor{stringliteral}{'name'}], $this->suggested\_value[\textcolor{stringliteral}{'gender'}], $this->
...
190         \}
191 
192         \textcolor{comment}{//Now delete all the suggestion approvals as they are of no use}
193         $this->\hyperlink{classsuggest_a32f9238a6ea3e85021319f6cec2f6fca}{approval\_delete}();
194 
195         \textcolor{comment}{//Now mark the suggestion as applied So that it can be used in future}
196         $db->get(\textcolor{stringliteral}{"update suggested\_info set approved=1 where id=$this->id"});
197     \}
\end{DoxyCode}
...
Definition at line 206 of file suggest.\-php.
...
207         global $db;
208 
209         \textcolor{keywordflow}{if} ($db->get(\textcolor{stringliteral}{"Delete from suggest\_approved where suggest\_id=$this->id"})) \{
210             \textcolor{keywordflow}{return} TRUE;
