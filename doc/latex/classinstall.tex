...
\begin{DoxyCode}
        ...
        \}
        $template->header();
        $template->display(\textcolor{stringliteral}{"install.directory\_check.tpl"});
    \}
\end{DoxyCode}
...
This class is used to start the installation.  string \$mode  integer \$sub \begin{DoxyReturn}{Returns}
null 
\end{DoxyReturn}
